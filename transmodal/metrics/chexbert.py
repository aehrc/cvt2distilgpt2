from transmodal.network.chexbert import CheXbert
from transmodal.metrics.natural_language import NaturalLanguage
from transmodal.utils import enumerated_save_path
import os
import pandas as pd
import time
import torch
...
class ClinicalEfficacy(NaturalLanguage):
    ...
    def __init__(
        ...
        super().__init__(device=device, dist_sync_on_step=False)
