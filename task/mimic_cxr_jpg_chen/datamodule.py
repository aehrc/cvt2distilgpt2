...
from task.mimic_cxr_jpg_chen.dataset import TaskSubset
import json
import os
import re
...
class TaskDataModule(DataModule):
    ...
    def setup(self, stage=None):
        ...
        if stage == "fit" or stage is None:
            ...
            print(
                "MIMIC-CXR-JPG Chen's labels no. of training & validation examples: {} & {}.".format(
        ...
        if stage == "test" or stage is None:
            ...
            print(
                "MIMIC-CXR-JPG Chen's labels no. of test examples: {}.".format(
